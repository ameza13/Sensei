...
"""
python sensei_vllm.py --model-id mistralai/Mixtral-8x7B-Instruct-v0.1 --backend vllm --tensor-parallel-size 8 --min_len 1 --max_len 7698 --dtype float16 --domain lang --outputs /path/to/save/dataset --num_instances 2
"""
...
def sensei(llm_pipeline, 
    ...
    print(f"Dataset file saved at: {output_file_path}")
...
if __name__ == "__main__":
    ...
    # TO DO: Add source to system_messages, create list of dicts to include source!
    if code_data:
    ...
    sensei(llm_pipeline=llm_pipeline,
           tokenizer=tokenizer,
